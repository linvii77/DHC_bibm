#!/bin/bash
#SBATCH --job-name=test_baseline_s666
...
#SBATCH --output=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_baseline_s666_%j.out
#SBATCH --error=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_baseline_s666_%j.err
