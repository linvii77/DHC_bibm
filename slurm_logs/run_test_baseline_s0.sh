#!/bin/bash
#SBATCH --job-name=test_baseline_s0
...
#SBATCH --output=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_baseline_s0_%j.out
#SBATCH --error=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_baseline_s0_%j.err
