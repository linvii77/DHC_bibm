#!/bin/bash
#SBATCH --job-name=test_no_var_s0
...
#SBATCH --output=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_no_var_s0_%j.out
#SBATCH --error=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_no_var_s0_%j.err
