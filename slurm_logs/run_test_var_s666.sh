...
#SBATCH --output=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_var_s666_%j.out
#SBATCH --error=/gpfs/work/aac/yuangluo22/DHC_bibm/slurm_logs/test_var_s666_%j.err
