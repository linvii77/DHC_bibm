#!/bin/bash
# Phase 7c: CDBA structural fixes – staggered warmup, backbone detach, voxel cap, softplus P2E
# Changes vs p7b: cdba_unlabeled_warmup=150, unlabeled backbone detached, voxel cap, softplus
# Usage: bash slurm/phase7c_cdba.sh
