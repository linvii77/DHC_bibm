#!/bin/bash
# Phase 7d: labeled-only CDBA (unlabeled warmup=9999, seed=666)
# cdba_unlabeled_warmup=9999 means unlabeled branch never activates
# Usage: bash slurm/phase7d_cdba_s666.sh
