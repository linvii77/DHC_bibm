#!/bin/bash
# Phase 7: CDBA-Variation fusion (E2P+P2E + logsumexp var_term, seed=0)
# Build on 5A best config; use_cdba replaces attraction/repulsion
# Usage: bash slurm/phase7_cdba.sh
